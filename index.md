...
* **NetBeans 10+ 汉化包** -[http://netbeans-locale-zh_cn.github.mycsoft.cn](http://netbeans-locale-zh_cn.github.mycsoft.cn)

> 本汉化包基于NetBeans 8.2. 亲测支持NetBeans 10.0。使用方法：将资源包解包后,复制到Netbeans 10 的安装目录.重启NetBeans后,就可以显示中文界面了. 仅以此汉化包献给广大喜欢NetBeans的程序猿.

* **宝贝成长星** -[http://babystar.github.mycsoft.cn](http://babystar.github.mycsoft.cn)
